...
This mechanism has been integrated into Bitcore-Node-CoreZ which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/corezcoin/insight-api-corez#web-socket-api](https://github.com/corezcoin/insight-api-corez#web-socket-api) 
* API: [https://github.com/corezcoin/insight-api-corez#instantsend-transactions](https://github.com/corezcoin/insight-api-corez#instantsend-transactions) 
...
By default, the CoreZ Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the CoreZ Core daemon:
