...
Only requiring some minor changes is corez.cpp.
...
Changes to corez.cpp
----------------------
corez.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
