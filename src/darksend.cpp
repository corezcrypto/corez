...
{
    if(fLiteMode) return; // ignore all CoreZ related functionality
...
/*
    ...
    allow endless transaction that would bloat CoreZ and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("corez-privatesend");
