 ...
 *
 *   // network
 *   CCoreZNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.corez.site/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CCoreZNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: CoreZNetwork
// //   -- signature requirements : Key1(User)
// class CCoreZNetworkVariable : public CGovernanceObject
// {
// private:
