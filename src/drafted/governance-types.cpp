...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "CoreZNetwork") type = CoreZNetwork;
    if(strType == "CoreZNetworkVariable") type = CoreZNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == CoreZNetwork) s = "CoreZNetwork";
    if(type == CoreZNetworkVariable) s = "CoreZNetworkVariable";
