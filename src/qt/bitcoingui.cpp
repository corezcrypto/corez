    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("CoreZ Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CoreZ address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and corez: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About CoreZ Core"), this);
    aboutAction->setStatusTip(tr("Show information about CoreZ Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CoreZ Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CoreZ addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CoreZ addresses"));
    ...
    openAction->setStatusTip(tr("Open a corez: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CoreZ Core help message to get a list with possible CoreZ Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("CoreZ Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CoreZ network", "", count));
}
...
{
    QString strTitle = tr("CoreZ Core"); // default title
