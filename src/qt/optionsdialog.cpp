    ...
    mapper(0)
{
    ...
    /* Theme selector */
    /*ui->theme->addItem(QString("CRZ-light"), QVariant("light"));*/
    ui->theme->addItem(QString("CRZ-blue"), QVariant("drkblue"));
    /*ui->theme->addItem(QString("CRZ-Crownium"), QVariant("crownium"));*/
    ui->theme->addItem(QString("CRZ-traditional"), QVariant("trad"));
