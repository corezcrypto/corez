    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("CoreZ Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About CoreZ Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  corez-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the CoreZ in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 CRZ, 0.1 CRZ, 1 CRZ and 10 CRZ -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://corezcoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://corezcoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("CoreZ Core is shutting down...") + "<br /><br />" +
