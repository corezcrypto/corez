...
2. run corezd with -printalert or -sendalert like this:
   /path/to/corezd -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.corez.site";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/CoreZ Core:0.12.0.58/"));
